...
class WeatherNetworkManager: NetworkManagerProtocol {
    ...
    func fetchCurrentWeather(city: String, completion: @escaping (WeatherModel) -> ()) {
        ...
        let apiURL = "https://api.openweathermap.org/data/2.5/weather?q=\(formattedCity)&appid=\(NetworkProperties.apiKey)"
    ...
    func fetchNextFiveWeatherForecast(city: String, completion: @escaping ([ForecastTemperature]) -> ()) {
        let formattedCity = city.replacingOccurrences(of: " ", with: "+")
        let apiURL = "https://api.openweathermap.org/data/2.5/forecast?q=\(formattedCity)&appid=\(NetworkProperties.apiKey)"
